...
word: 代表该名词英文单词的特征，可以从字母数量的范围、开头/结尾/中间的特定字母、音节数量与元音辅音数量或位置等等进行描述。例如“长度为 4-8 个字母”、“包含两个或更多不同的元音”、“以 A 到 M 之间的字母开头”等。
attribute: 代表人类可能对该名词抱有的主观感觉，这里你可以自由地发挥，可以说得非常模糊，例如“大多数人家里都有”，“通常多个一起出现”，“可以在商店购买”，“具有历史意义”等。
context: 代表物体可能具有的客观特性，例如“形状不规则”，“寿命长”，“可以折叠或弯曲”，“经常发出声音”等。
`,
      },
    ],
